...
This mechanism has been integrated into Bitcore-Node-StoneCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/stonecrypto/insight-api-stonecoin#web-socket-api](https://github.com/stonecrypto/insight-api-stonecoin#web-socket-api) 
* API: [https://github.com/stonecrypto/insight-api-stonecoin#instantsend-transactions](https://github.com/stonecrypto/insight-api-stonecoin#instantsend-transactions) 
...
By default, the StoneCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the StoneCoin Core daemon:
