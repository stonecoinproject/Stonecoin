...
* WebSocket: [https://github.com/stone/insight-api-stone#web-socket-api](https://github.com/stone/insight-api-stone#web-socket-api) 
* API: [https://github.com/stone/insight-api-stone#instantsend-transactions](https://github.com/stone/insight-api-stone#instantsend-transactions) 
...
By default, the Stone Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Stone Core daemon:
