...
StoneCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 22323.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 22324 for connections and services them.
...
However, in open source software such as StoneCoin Core, where everyone uses
...
pay attention to for reviewers of StoneCoin Core code.

General StoneCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: StoneCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
