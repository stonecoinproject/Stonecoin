...
Only requiring some minor changes is stone.cpp.
...
Changes to stone.cpp
----------------------
stone.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
