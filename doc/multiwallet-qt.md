...
Only requiring some minor changes is stonecoin.cpp.
...
Changes to stonecoin.cpp
----------------------
stonecoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
