...
Format: ```mngovernance prepare proposal-name url payment-count block-start stone-address monthly-payment-stone```
...
Format: ```mngovernance submit proposal-name url payment-count block-start stone-address monthly-payment-stone fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using stone.conf setup)
