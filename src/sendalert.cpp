...
2. run stonecoind with -printalert or -sendalert like this:
   /path/to/stonecoind -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.stonecoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/StoneCoin Core:0.12.0.58/"));
