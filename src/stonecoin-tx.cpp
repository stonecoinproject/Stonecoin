...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("StoneCoin Core stonecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  stonecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stonecoin transaction") + "\n" +
              "  stonecoin-tx [options] -create [commands]   " + _("Create hex-encoded stonecoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded stonecoin transaction
