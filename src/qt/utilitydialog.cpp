    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Stone Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Stone Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  stone-qt [" + tr("command-line options") + "]                     " + "\n";
...
PrivateSend uses an stonetive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 STONE, 0.1 STONE, 1 STONE and 10 STONE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://stone.atlassian.net/wiki/display/DOC/PrivateSend\">https://stone.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Stone Core is shutting down...") + "<br /><br />" +
