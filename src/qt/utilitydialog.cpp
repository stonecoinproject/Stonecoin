    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("StoneCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About StoneCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  stonecoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the StoneCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://dash.atlassian.net/wiki/display/DOC/PrivateSend\">https://dash.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("StoneCoin Core is shutting down...") + "<br /><br />" +
