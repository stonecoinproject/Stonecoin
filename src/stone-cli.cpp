...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Stone Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  stone-cli [options] <command> [params]  " + _("Send command to Stone Core") + "\n" +
                  "  stone-cli [options] help                " + _("List commands") + "\n" +
                  "  stone-cli [options] help <command>      " + _("Get help for a command") + "\n";
